...
<body>
		...
		<div class="wrap-contact100">
                    <form action='checkInFinal.php' method='GET'>
                                                

				<div class="wrap-input100 validate-input" data-validate="Last name is required">
					<span class="label-input100">Adauga greutate bagaje</span>
					<input class="input100" type="text" name="bagaj" placeholder="Adauga greutate bagaje">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate="First name is required">
					<span class="label-input100">Selectati Locul</span>
					<input class="input100" type="text" name="loc" placeholder="Selectati Locul">
					<span class="focus-input100"></span>
				</div>
